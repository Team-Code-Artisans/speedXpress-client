        ...
        <div className='px-10 py-20'>
            <section className="bg-white dark:bg-gray-900">
                <div className="container px-6 py-10 mx-auto">
                    <h1 className="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">explore our <br /> awesome Features</h1>
                    ...
                    <div className="mt-8 xl:mt-12 lg:flex lg:items-center">
                        <div className="grid w-full grid-cols-1 gap-8 lg:w-1/2 xl:gap-16 md:grid-cols-2">
                            <div className="space-y-3">
                                ...
                                <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Shipment Tracking</h1>
                            ...
                            <div className="space-y-3">
                                ...
                                <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Online Order Placement</h1>
                            ...
                            <div className="space-y-3">
                                ...
                                <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Warehouse Management</h1>
            ...
            <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
                <div className="p-8 space-y-3 border-2 border-orange-400 dark:border-orange-300 rounded-xl">
                    <span className="inline-block text-orange-500 dark:text-orange-400">
                    ...
                    <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Route Planning</h1>
                    ...
                    <a href="#" className="inline-flex p-2 text-orange-500 capitalize transition-colors duration-300 transform bg-orange-100 rounded-full rtl:-scale-x-100 dark:bg-orange-500 dark:text-white hover:underline hover:text-orange-600 dark:hover:text-orange-500">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="p-8 space-y-3 border-2 border-orange-400 dark:border-orange-300 rounded-xl">
                    ...
                    <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Supplier and Vendor Management</h1>
                ...
                <div className="p-8 space-y-3 border-2 border-orange-400 dark:border-orange-300 rounded-xl">
                    ...
                    <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Reporting and Analytics</h1>
                ...
                <div className="p-8 space-y-3 border-2 border-orange-400 dark:border-orange-300 rounded-xl">
                    ...
                    <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Document Management</h1>
                ...
                <div className="p-8 space-y-3 border-2 border-orange-400 dark:border-orange-300 rounded-xl">
                    ...
                    <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Integration with Carriers and Third-Party Systems</h1>
                ...
                <div className="p-8 space-y-3 border-2 border-orange-400 dark:border-orange-300 rounded-xl">
                    ...
                    <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Customer Support and Communication</h1>
                ...
                <div className="p-8 space-y-3 border-2 border-orange-400 dark:border-orange-300 rounded-xl">
                    ...
                    <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Automated Notifications</h1>
                ...
                <div className="p-8 space-y-3 border-2 border-orange-400 dark:border-orange-300 rounded-xl">
                    ...
                    <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Returns and Reverse Logistics</h1>
                ...
                <div className="p-8 space-y-3 border-2 border-orange-400 dark:border-orange-300 rounded-xl">
                    ...
                    <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Security and Data Protection</h1>
