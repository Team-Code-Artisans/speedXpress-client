        ...
        <div className="flex justify-center items-center 2xl:container 2xl:mx-auto lg:py-16 md:py-12 py-9 px-4 md:px-6 lg:px-20 xl:px-44">
            <div className="flex xl:w-[40%] w-full flex-col justify-start items-start">
                ...
                <Tabs activeStatus={activeStatus} setActiveStatus={setActiveStatus} />
                {
                    activeStatus === 1 &&
                    <>
                        <button onClick={handleGoogleSignIn} aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-orange-400 mt-6">
