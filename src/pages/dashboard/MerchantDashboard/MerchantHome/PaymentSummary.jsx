...
import { MdOutlinePayments, MdPayment, MdPendingActions } from "react-icons/md";

const PaymentSummary = ({ totalAmount, totalPendingAmount }) => {
  return (
    <div className="my-10">
      ...
      <div className="grid md:grid-cols-3 grid-cols-1 gap-8">
        ...
        <div className=" space-y-4 rounded-xl bg-blue-100 p-2 md:p-4 shadow-xl">
          <div className="bg-blue-200 rounded-2xl p-2 inline-block shadow-xl">
            <MdOutlinePayments size={"2rem"} className=" text-blue-600" />
          </div>
        ...
        <div className=" space-y-4 rounded-xl bg-blue-100 p-2 md:p-4 shadow-xl">
          ...
          <p className="text-lg text-gray-600 ">
            <span className=" text-2xl font-semibold">{totalPendingAmount}</span>{" "}
            <FiDollarSign className="inline-block" />
          </p>
        </div>
      </div>
