    ...
    return (
        <div className="bg-white p-8 rounded-md w-full">
            <div className=" lg:flex items-center justify-between pb-6">
                <div>
                    <h2 className="text-gray-600 font-semibold text-3xl">All  Completed <span className="text-orange-600">Delivery</span></h2>
                </div>
                            ...
                            <tbody>
                                {[1, 2, 3, 4, 5, 6, 7, 8].map(el => (
                                    <tr key={el}>
                                        ...
                                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <p className="text-slate-50 whitespace-no-wrap bg-green-400 py-1 rounded-full text-center ">
                                                completed
                                            </p>
                                        </td>
                                    </tr>
