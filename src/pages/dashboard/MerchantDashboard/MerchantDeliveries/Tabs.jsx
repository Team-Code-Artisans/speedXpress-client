...
const Tabs = ({ activeStatus, setActiveStatus }) => {
    return (
        <div className="h-12 bg-white shadow rounded mb-6">
            <ul className="flex gap-4 md:gap-10 px-5">
                ...
                <li onClick={() => setActiveStatus(2)} className={activeStatus == 2 ? "text-sm md:text-xl border-orange-700 pt-3 rounded-t text-orange-700" : "text-sm md:text-xl text-gray-600 py-3 flex items-center hover:text-orange-700 cursor-pointer"}>
                    <div className="flex md:gap-2 gap-1 items-center mb-3">
                ...
                <li onClick={() => setActiveStatus(3)} className={activeStatus == 3 ? "text-sm md:text-xl border-orange-700 pt-3 rounded-t text-orange-700" : "text-sm md:text-xl text-gray-600 py-3 flex items-center hover:text-orange-700 cursor-pointer"}>
