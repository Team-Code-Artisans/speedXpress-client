...
const MerchantDeliveries = () => {
    ...
    return (
        <div className='max-w-screen-2xl mx-auto px-4'>
            <div className='my-10'>
                <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl">All <span className='text-orange-600'>Deliveries</span></h1>
            ...
            <div className="bg-white rounded-md w-full">
                <div className=" lg:flex items-center justify-between pb-6">
                    <div>
                        <Tabs setActiveStatus={setActiveStatus} activeStatus={activeStatus} />
                    </div>
