    ...
    return (
        <div className="h-12 bg-white shadow rounded mb-6">
            <ul className="flex gap-4 md:gap-10 px-5 cursor-pointer">
                <li onClick={() => setActiveStatus(1)} className={activeStatus == 1 ? "text-sm md:text-xl border-orange-700 pt-3 rounded-t text-orange-700" : "text-sm md:text-xl text-gray-600 py-3 flex items-center hover:text-orange-700"}>
