...
import RegularDocument from "./RegularDocument";


const RegularInvoiceTable = ({ isLoading, filterData, handleCopy, refetch, componentRef }) => {
...
export default RegularInvoiceTable;
