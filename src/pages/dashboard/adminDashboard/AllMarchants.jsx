          ...
          <div className=" lg:flex items-center justify-between pb-6">
            <div>
              <h2 className="text-gray-600 font-semibold text-3xl">
                All <span className="text-orange-600">marchents</span>
              </h2>
            </div>
              ...
              <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
                      ...
                      <tr key={el}>
                        ...
                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm flex space-x-4 ">
                          <span className="text-gray-900 hover:text-orange-600 whitespace-no-wrap text-xl cursor-pointer">
                            <HiPencilSquare
                              onClick={() => alert("functionlity is good")}
                            ></HiPencilSquare>
                          </span>
                          <span className="text-gray-900  hover:text-orange-600 whitespace-no-wrap text-xl cursor-pointer">
                            <MdDeleteOutline
                ...
                <div className="px-5 py-5 bg-white border-t flex flex-col xs:flex-row items-center xs:justify-between          ">
                  ...
                  <div className="inline-flex mt-2 xs:mt-0">
                    <button className="text-sm text-indigo-50 transition duration-150 hover:bg-orange-600 bg-gray-800 font-semibold py-2 px-4 rounded-l">
                      Prev
                    </button>
                    &nbsp; &nbsp;
                    <button className="text-sm text-indigo-50 transition duration-150 hover:bg-orange-600 bg-gray-800 font-semibold py-2 px-4 rounded-r">
                      Next
                    </button>
                  </div>
                </div>
