            ...
            <div className="relative">
                ...
                <div className="w-full md:max-w-sm mt-6 bg-gray-800 md:rounded-md absolute md:bottom-10 bottom-0 md:right-10">
                    <form className="flex flex-col md:flex-row">
                        <input type="email" placeholder="Enter Tracking Number" className="flex-1 px-4 py-2 m-1 text-white text-center md:text-left placeholder-gray-400 placeholder:text-center md:placeholder:text-left bg-transparent border-none appearance-none focus:outline-none focus:placeholder-transparent focus:ring-0" />
