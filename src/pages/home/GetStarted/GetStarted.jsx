    ...
    return (
        <div className="container mx-auto py-9 md:py-12 lg:py-24">
            <div className="relative mx-4">
                ...
                <button className="absolute bottom-0 sm:hidden bg-gray-800 py-4 text-base font-medium text-white mt-8 flex justify-center items-center w-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 hover:bg-gray-700">Explore</button>
            </div>
        </div>
    );
};
